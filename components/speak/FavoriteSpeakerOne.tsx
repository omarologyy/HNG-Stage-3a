...
import BGW from "@/public/images/speakerImgs/BigBlackSmallWhite.svg";
...
import MarkOne from "@/public/images/headphoneImgs/MarkingOne.svg";
import SpeakerHead from "@/public/images/headphoneImgs/SpeakerProductDetailOne.svg";

function FavoriteSpeakerOne() {
  return (
    <>
      {/* DESKTOP VIEW */}
        ...
        <div className="mt-16 space-x-[30px] flex">
          <div className="flex flex-col justify-center items-center">
            <div className="card-speaker-product-desktop relative">
              <Image src={BGW} alt="black headphones" />
            </div>
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="card-speaker-product-desktop relative">
              <Image src={MarkOne} alt="white headphones" />
            </div>
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="card-speaker-product-desktop relative">
              <Image src={WhiteHeadDesktop} alt="black head speaker" />
            </div>
            <h3 className="mt-8 font-bold text-[24px]">ZX9 SPEAKER</h3>
            <button className="card-headphone-cart-two text-white mt-8">
              SEE PRODUCT
        ...
        <div className="mt-14">
          <div className="flex flex-col justify-center items-center mt-10">
            <div className="card-speaker-product relative">
              <Image src={SpeakerHead} alt="speaker" />
            </div>
            <h3 className="mt-8 font-bold text-[24px]">ZX9 SPEAKER</h3>
            <button className="card-headphone-cart-two text-white mt-8">
              SEE PRODUCT
          ...
          <div className="flex flex-col justify-center items-center mt-10">
            <div className="card-speaker-product relative">
              <Image src={BlackHead} alt="Black headphones" />
            </div>
            <h3 className="mt-8 font-bold text-[24px]">XX9 MARK I </h3>
            <button className="card-headphone-cart-two text-white mt-8">
              SEE PRODUCT
            </button>
          </div>
          <div className="flex flex-col justify-center items-center mt-10">
            <div className="card-speaker-product relative">
              <Image src={WhiteHead} alt="White headphones" />
            </div>
            <h3 className="mt-8 font-bold text-[24px]">XX59</h3>
            <button className="card-headphone-cart-two text-white mt-8">
              SEE PRODUCT
...
export default FavoriteSpeakerOne;
