...
import ZHead from "@/public/images/speakerImgs/Zspeaking.svg";
import SpeakerHead from "@/public/images/headphoneImgs/SpeakerProductDetailOne.svg";

function FavoriteSpeaker() {
  return (
    <>
      {/* DESKTOP VIEW */}
        ...
        <div className="mt-16 space-x-[30px] flex">
          <div className="flex flex-col justify-center items-center">
            <div className="card-speaker-product-desktop relative">
              <Image src={ZHead} alt="black headphones" />
            </div>
            <h3 className="mt-8 font-bold text-[24px]">ZX7 SPEAKER</h3>
